...
public :
   ...
   ZprimeMuMuPatMiniAodNewMC(Char_t namechar_[300],TTree *tree=0,Double_t weight_=1.,string DATA_type_="DATA",string MC_type_="MC");
...
ZprimeMuMuPatMiniAodNewMC::ZprimeMuMuPatMiniAodNewMC(Char_t namechar_[300], TTree *tree,Double_t weight_,string DATA_type_,string MC_type_) : fChain(0)
{

...
echo "Reading data_input_${data}_${subflav}_AN.txt file"

cp -f data_input_${data}_${subflav}_AN.txt data_input.txt
nlines=`wc -l data_input_${data}_${subflav}_AN.txt | awk '{print $1}'`;

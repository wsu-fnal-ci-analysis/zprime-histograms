...
private:
  ...
  bool useDYJets,useDYJetsFromData,useDiJetsFromFakeRateFromData,useWJetsFromFakeRateFromMC;
...
//   Color_t h400Color = kRed;
  ...
  if (histlabel.find("hM4l_8")<10 ) outputyields << "Data " << totaldataentries << " +/- 0" << endl;
  ...
  if (histlabel.find("hM4l_8")<10 ) outputyields << "Z+X " << htotalHisto->Integral(0,-1) << " +/- 0" << endl;
  ...
  for ( int datasetId=Vdatasetnamebkg.size()-1; datasetId >=0; datasetId--){  
	...
	char temp[328];
	sprintf(temp,"%s",histosdir.c_str());
	if(datasetnamebkg.find(temp) < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) && hfourlepbestmass_4l_afterSel_new_ggH->GetEntries()>0. ) legend->AddEntry(hfourlepbestmass_4l_afterSel_new_new,Vlabelbkg.at(datasetId).c_str(), "F");  
	...
	char temp[328];
	sprintf(temp,"%s",histosdir.c_str());
	if(datasetnamebkg.find(temp) < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) && hfourlepbestmass_4l_afterSel_new_ttH->GetEntries()>0. ) legend->AddEntry(hfourlepbestmass_4l_afterSel_new_new,Vlabelbkg.at(datasetId).c_str(), "F");  
	//hfourlepbestmass_4l_afterSel_new_new->Draw("sameP");    
      }
	...
	char temp[328];
	sprintf(temp,"%s",histosdir.c_str());
	if(datasetnamebkg.find(temp) < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) && hfourlepbestmass_4l_afterSel_new_VBFH->GetEntries()>0. ) legend->AddEntry(hfourlepbestmass_4l_afterSel_new_new,Vlabelbkg.at(datasetId).c_str(), "F");  
	//hfourlepbestmass_4l_afterSel_new_new->Draw("sameP");    
      }
	...
	char temp[328];
	sprintf(temp,"%s",histosdir.c_str());
	if(datasetnamebkg.find(temp) < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) && hfourlepbestmass_4l_afterSel_new_VH->GetEntries()>0. ) legend->AddEntry(hfourlepbestmass_4l_afterSel_new_new,Vlabelbkg.at(datasetId).c_str(), "F");  
	//hfourlepbestmass_4l_afterSel_new_new->Draw("sameP");    
       }
	...
	hfourlepbestmass_4l_afterSel_new_DY->SetLineColor(kAzure-9);
        ...
        if(datasetnamebkg.find(temp) <200 && (datasetnamebkg.find(whichenergy) < 200 && datasetnamebkg.find("DYJetsToTauTau")<200)){
          cout << "DY->tautau= " << hfourlepbestmass_4l_afterSel_new_DYtautau->Integral(0,-1) << endl;
	...
	if(datasetnamebkg.find("WW") < 200){
	  ...
	  if( datasetnamebkg.find("WWTo2L2Nu_13TeV") < 200 && datasetnamebkg.find(temp) < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) && hfourlepbestmass_4l_afterSel_new_diBoson->GetEntries()>0. ) legend->AddEntry(hfourlepbestmass_4l_afterSel_new_diBoson,"WW, WZ, ZZ", "F");
	...
	if(datasetnamebkg.find("TTToLL_MLL") < 200 || datasetnamebkg.find("TTTo2L2Nu")<200 ){ 
	  ...
	  //hfourlepbestmass_4l_afterSel_new_new->Draw("sameP");
	  if( datasetnamebkg.find("TTTo2L2Nu") < 200  && datasetnamebkg.find(temp) < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) && hfourlepbestmass_4l_afterSel_new_Tlike->GetEntries()>0. ) legend->AddEntry(hfourlepbestmass_4l_afterSel_new_Tlike,"t#bar{t}, tW, #bar{t}W", "F");	  
	...
	if(datasetnamebkg.find("_WJ")<200 && useWJetsFromFakeRateFromMC==false){
	  cout << "Wjets" << endl;
	...
	"  Entries= " << hfourlepbestmass_4l_afterSel_new_new->Integral(0,-1);
      ...
      if(datasetnamebkg.find("GluGluToZZTo2L2L") < 200 && (datasetnamebkg.find(whichenergy) < 200 || datasetnamebkg.find(whichsample) < 200) ){ 
    ...
    //else if( datasetnamebkg.find("_ZZTo") < 200 ){
      ...
      else if (whichsample.find("13TeV")<200) sprintf(temp,"%s/output_ZZ_%s",histosdir.c_str(),whichsample.c_str());
	...
	cout << "Label= qqZZ     Entries= " << hfourlepbestmass_4l_afterSel_new_qqZZ->Integral(0,-1) <<endl;
        cout << "Label= qqZZ+ggZZ   Entries= " << hfourlepbestmass_4l_afterSel_new_ZZ->Integral(0,-1) 
	     << "  Error= " << errorZZ <<endl;
	if (histlabel.find("hM4l_8")<10 ) outputyields << "ZZ " << hfourlepbestmass_4l_afterSel_new_ZZ->Integral(0,-1) << " +/- " << errorZZ << endl;
	...
	cout << "Label= qqZZ+ggZZ (mll>100 and mll<800)  bins=" << bin100 << "-" << bin800 << " Entries= " << hfourlepbestmass_4l_afterSel_new_ZZ->Integral(bin100,bin800) <<endl;
    ...
    else if (useDYJetsFromData==false &&  useDiJetsFromFakeRateFromData==false){      
    ...
    else if (whichsample.find("13TeV")<200) sprintf(tempp,"%s/output_ZZ_%s",histosdir.c_str(),whichsample.c_str());    
    
    //cout << "tempp is " << tempp << endl;

    if(datasetnamebkg.find(tempp) < 300) {
      cout << "Stacking ZZ " << tempp << endl;
	 ...
	 cout << "Adding WW or diBoson" << endl;
	 ...
	 htotal->Add(hfourlepbestmass_4l_afterSel_new_Tlike);
       ...
       if (useDiJetsFromFakeRateFromData==true){
	 cout << "Adding Dijets with BR method from data" << endl;
	 ...
	 useDiJetsFromFakeRateFromData=false;
       ...
       else if (useDiJetsFromFakeRateFromData==false){
	 ...
	 if(datasetnamebkg.find(temppp) < 200 && datasetnamebkg.find("output_QCD_Pt_1000to1400") < 200 ){     
       ...
       if(useWJetsFromFakeRateFromMC==false && datasetnamebkg.find(temppp) < 200 && (
	 ...
	 cout << "Stacking W+jets" << endl;
       ...
       if(datasetnamebkg.find(temppp) < 200 && datasetnamebkg.find("output_ST_") < 200 && datasetnamebkg.find("t-channel_antitop") < 200 ){     	 
	 cout << "Adding Single Top" << endl;
  ...
  */
  ...
  TH1F *hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300 = new TH1F("hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300", "hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300", Nbins, Xmin, Xmax);
  TH1F *hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800 = new TH1F("hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800", "hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800", Nbins, Xmin, Xmax);
  ...
  for ( int datasetIdSig=Vdatasetnamesig.size()-1; datasetIdSig >=0; datasetIdSig--){  
    ...
    if(datasetnamesig.find("CITo2Mu_Lam10TeV_LLConM300")<200) hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300->Add(hfourlepbestmass_4l_afterSel_new_new);
    if(datasetnamesig.find("CITo2Mu_Lam10TeV_LLConM800")<200) hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800->Add(hfourlepbestmass_4l_afterSel_new_new);

    if(datasetnamesig.find("Zprime")<200 && datasetnamesig.find("5000")<200) hfourlepbestmass_4l_afterSel_new_Zprime5000->Add(hfourlepbestmass_4l_afterSel_new_new);
    
  }
  
  // Zprime signal
  cout << "Zprime Signal expected at m_Z'=5000 GeV is " << hfourlepbestmass_4l_afterSel_new_Zprime5000->Integral(0,-1) << " +/- " << errorH125 << endl;
  if (histlabel.find("ZprimeRecomass")<20 ) 
    outputyields << "m_Z'=5 TeV " << hfourlepbestmass_4l_afterSel_new_Zprime5000->Integral(0,-1) << " +/- " << errorH125 << endl;      
  ...
  // Contact Interaction
  cout << "CI Signal expected at lambda=10TeV, m_X=300 GeV is " << hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300->Integral(0,-1) << endl;  
  if (histlabel.find("CITo2Mu_Lam10TeV_LLConM300")<20 ) 
    outputyields << "CI:lambda=10TeV, m_X=300 GeV " << hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300->Integral(0,-1) << endl;      

   cout << "CI Signal expected at lambda=10TeV, m_X=800 GeV is " << hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800->Integral(0,-1) << endl;  
  if (histlabel.find("CITo2Mu_Lam10TeV_LLConM800")<20 ) 
    outputyields << "CI: lambda=10TeV, m_X=800 GeV" << hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800->Integral(0,-1) << endl;      
  

  hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300->SetMarkerSize(0.95);
  hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300->SetMarkerColor(kRed-4);
  hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300->SetLineColor(kRed-4);
  hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300->SetLineWidth(2);

  hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800->SetMarkerSize(0.95);
  hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800->SetMarkerColor(kOrange-4);
  hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800->SetLineColor(kOrange-4);
  hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800->SetLineWidth(2);
  ...
  // Contact Interaction
  //hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300->Draw("same");
  htotal->Add(hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300);
  legend->AddEntry(hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM300,"#Lambda = 10 TeV (m_{#mu^{+} #mu^{-}} = 300 GeV)", "L");

  //hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800->Draw("same");
  //htotal->Add(hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800);
  //legend->AddEntry(hfourlepbestmass_4l_CITo2Mu_Lam10TeV_LLConM800,"#Lambda = 10 TeV (m_{#mu^{+} #mu^{-}} = 800 GeV)", "L");

  if (histlabel.find("ZprimeRecomass")<20){
    cout << "Plotting di-lepton mass" << endl;
    //htotal->Add(hfourlepbestmass_4l_afterSel_new_Zprime5000);
  ...
  std::string saveasrootzoom = useLogY ? "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_zoom_log.root" : "plots/h_"+histlabel+"_"+whichchannel+"_"+whichenergy+"_zoom.root";
  ...
  if (nRebin==1){
    ...
    if (useDiJetsFromFakeRateFromData) hfourlepbestmass_4l_afterSel_DiJetsFromFakeRateFromData_new_new->Write();
    if (useWJetsFromFakeRateFromMC) hfourlepbestmass_4l_afterSel_WJetsFromFakeRateFromMC_new_new->Write();
    file1->Write();
    file1->Close();
  }
...
void PlotStackZprime::setSamplesNames4l()
{
  ...
  while(std::getline(infile,inputfilename)){
    ...
    if(inputfilename.find("_SingleMuon")<200){ // as many times as it occurs in the input file
      Vdatasetnamedata.push_back(inputfilename);
      Vlabeldata.push_back("2016");
      Vxsectiondata.push_back(1.); //pb
    }     
...
//       } 
	...
	Vcolorbkg.push_back(kTeal-6);
      ...
      if(inputfilename.find("ST_s-channel_top")<200 || inputfilename.find("T_TuneZ2_s-channel")<200 || inputfilename.find("singletop")<200){
	Vdatasetnamebkg.push_back(inputfilename);
	...
	Vcolorbkg.push_back(kViolet);
      ...
      if(inputfilename.find("ST_t-channel_top")<200 || inputfilename.find("T_TuneZ2_t-channel")<200){
	Vdatasetnamebkg.push_back(inputfilename);
	...
	Vcolorbkg.push_back(kViolet);
      ...
      if(inputfilename.find("tW_top")<200 || inputfilename.find("T_TuneZ2_tW-channel")<200 ){
	Vdatasetnamebkg.push_back(inputfilename);
	...
	Vcolorbkg.push_back(kViolet);
      ...
      if(inputfilename.find("ST_s-channel_antitop")<200 || inputfilename.find("Tbar_TuneZ2_s-channel")<200 ){
	Vdatasetnamebkg.push_back(inputfilename);
	...
	Vcolorbkg.push_back(kViolet);
      ...
      if(inputfilename.find("ST_t-channel_antitop")<200 || inputfilename.find("Tbar_TuneZ2_t-channel")<200 ){
	Vdatasetnamebkg.push_back(inputfilename);
	Vlabelbkg.push_back("ST_t-channel_top_4f_leptonDecays_13TeV-powheg-pythia8");
	Vxsectionbkg.push_back(1.); //pb
	Vcolorbkg.push_back(kViolet);
      ...
      if(inputfilename.find("ST_tW_antitop")<200 || inputfilename.find("tbarW")<200 ){
	Vdatasetnamebkg.push_back(inputfilename);

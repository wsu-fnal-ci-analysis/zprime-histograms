...
class ZprimeMuMuPatMiniAodNewData {
  ...
  */
  ...
  /* std::array<std::array<std::shared_ptr<TH1D>,4> 3> h1_SmearedMassBinned_; */
  /* std::array<std::array<std::shared_ptr<TH1D>,4> 3> h1_MassBinned_       ; */
  /* std::array<std::array<std::shared_ptr<TH1D>,4> 3> h1_MassUpBinned_     ; */
  /* std::array<std::array<std::shared_ptr<TH1D>,4> 3> h1_MassDownBinned_   ; */
  ...
  std::shared_ptr<TH1D> h_ptHistoFRDum_;
  std::shared_ptr<TH1D> h_ptHistoFRNum_;
  ...
  std::shared_ptr<TH2D> h2_ZprimeRecomassNewbin_;
  std::shared_ptr<TH1D> h1_ZprimeRecomassBinWidth_;
  int NbFireHLT;
  std::shared_ptr<TH1D> h_NbFireHLT;
